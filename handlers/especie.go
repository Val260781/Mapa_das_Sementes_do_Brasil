...
func EditarEspecie(c *gin.Context) {
	...
	if input.NomeCientifico != "" {
		updates["nome_cientifico"] = input.NomeCientifico
	}
	if input.NomePopular != "" {
		updates["nome_popular"] = input.NomePopular
	}
	if input.Familia != "" {
		updates["familia"] = input.Familia
	}
	if input.Bioma != "" {
	...
	if input.UsosArtesanais != "" {
		updates["usos_artesanais"] = input.UsosArtesanais
	}
	if input.EpocaColheita != "" {
		updates["epoca"] = input.EpocaColheita
	}
	if input.StatusConservacao != "" {
		updates["status_conservacao"] = input.StatusConservacao
	}
